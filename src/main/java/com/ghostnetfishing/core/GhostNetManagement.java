...
public class GhostNetManagement {
	...
	/**
	 * Methode zum Abfragen aller Geisternetze mithilfe des Data Access Objects für die Geisternetze
	...
	/**
	 * Methode für die Validierung des Benutzernamens, prüfz ob der benutzername in der Datenbank vorhanden ist bzw. ob dieser bereits registriert wurde
	...
	/**
	 * Überprüft, ob das eingegenene Passwort zu dem vorher gesuchten Benutzer passt. Es werden jeweils die Hashes der Passwörter verglichen
